...
@Entity
@Table(name = "ebm_purchase_item")
@Data
@Builder
@AllArgsConstructor
@RequiredArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class EbmPurchaseItem extends AbstractEntity {
	/**
	* 
	*/
	...
	@JoinColumn(name = "ebm_purchase_id", unique = false, nullable = true, insertable = true, updatable = true)
	private EbmPurchase ebmPurchase;
