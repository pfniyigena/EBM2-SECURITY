...
public class EbmPurchase extends AbstractEntity {
	/**
	* 
	*/
	...
	@ToString.Exclude
	@OneToMany(mappedBy = "ebmPurchase", cascade = { CascadeType.ALL }, fetch = FetchType.LAZY,orphanRemoval = true)
	private List<EbmPurchaseItem> purchaseItems;
